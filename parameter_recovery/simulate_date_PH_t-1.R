...
# simulate data
sim<-simulate_PearceHall_t_1(Data=Data,alpha=0.5, beta =5,k=0.5, gamma=0.1 ,
...
ggplot(sim, aes(x=trialN))+
  ...
  # geom_line(aes(y=P3),size = 1.5, color = "brown")+
  # geom_line(aes(y=P4), size = 1.5,color = "orange")+
  geom_line(aes(y=absDelta), color = "red")+
  theme_bw()+
