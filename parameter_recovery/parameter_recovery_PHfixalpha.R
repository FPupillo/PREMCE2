#------------------------------------------------------------------------------#
# simulating trials switch points and character - Pearce Hall_instr fix alpha
...
source("computational_model/simulation_functions/simulate_PearceHall_fixalpha.R")
