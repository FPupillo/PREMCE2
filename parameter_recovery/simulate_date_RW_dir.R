#------------------------------------------------------------------------------#
# simulating trials switch points and character and analyse results - die
...
source("simulation_functions/simulate_RescorlaWagner_dir.R")
...
# simulate data
sim<-simulate_RescorlaWagner_dir(Data=Data,
                        alpha =0.5 , beta = 1
                        ,  initialV = 0.25)
