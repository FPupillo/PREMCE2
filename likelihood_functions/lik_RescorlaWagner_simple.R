lik_RescorlaWagner_simple<-function (Data,alpha, beta,print,  initialV){
  ...
  #we also need posterior
  Postindex<-c("Post1", "Post2", "Post3", "Post4") 
  ...
  for (t in 1: nrow(Data) ){
    ...
    # update choice probabilities to get the post
    post<-softmax(V, beta)
    
    Data[t, Postindex]<-post
