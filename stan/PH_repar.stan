...
parameters {
  ...
  */
  real<lower=0,upper=1> alpha0_mu_pr; // gamma at the poulation level  - uniform
  real<lower=0,upper=10> beta_mu_pr;
  real<lower=0,upper=1> k_mu_pr;
  real<lower=0,upper=1> gamma_mu_pr;
  ...
  vector[nSubjects] k_pr;  
  vector[nSubjects] alpha0_pr; 
...
transformed parameters{
  ...
  vector<lower=0,upper=1>[nSubjects] gamma; // weight between prediction error and associability
